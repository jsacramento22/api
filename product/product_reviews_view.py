...
from models.product.product_reviews_model import ProductReviewsModel
...
class ProductReviewsView(ProductReviewsModel):
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='shop_product_reviews', data=resp_dict)
