...
from models.sales.negotiation_history_model import SalesNegotiationHistoryModel
...
class SalesNegotiationHistoryView(SalesNegotiationHistoryModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='mkpl_sales_negotiation_history',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_negotiation_hash'] = self.unique_negotiation_hash_string(
            unique_marketplace_hash)

        res = self.el.insert_el(
            index='mkpl_sales_negotiation_history', data=resp_dict)
    ...
    def unique_negotiation_hash_string(self, unique_marketplace_hash):
        import json
        import hashlib
        ...
        unique_negotiation_hash = hashlib.sha256(block_string).hexdigest()

        return unique_negotiation_hash
