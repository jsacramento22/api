...
from models.store.store_inventory_model \
    import StoreInventoryModel
...
class StoreInventoryView(StoreInventoryModel):
    ...
    def insert(self, request):
        ...
        '''
        resp_dict['unique_campaign_hash'] = self.unique_campaign_hash_string(
    ...
    def unique_campaign_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_campaign_hash = hashlib.sha256(block_string).hexdigest()

        return unique_campaign_hash
