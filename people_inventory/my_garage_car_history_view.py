...
from models.people_inventory.my_garage_car_history_model \
    import MyGarageCarHistoryModel
...
class MyGarageCarHistoryView(MyGarageCarHistoryModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_inventory_my_garage_car_history',
    ...
    def insert(self, request):
        ...
        unique_vehicle_hash = data.get('unique_vehicle_hash', '')
        if not unique_vehicle_hash:
            resp_dict['status'] = 'Error'
            resp_dict['status_desc'] = 'Campo unique_vehicle_hash não ' + \
                'especificado.'
            return jsonify(resp_dict), 400
