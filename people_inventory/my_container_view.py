...
from models.people_inventory.my_container_model import MyContainerModel
...
class MyContainerView(MyContainerModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        unique_personal_hash = data.pop('unique_personal_hash', None)
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_inventory_my_container',
            unique_hash_field='unique_personal_hash',
            unique_hash_value=unique_personal_hash,
    ...
    def insert(self, request):
        ...
        resp_dict['unique_container_hash'] = self.unique_container_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_inventory_my_container', data=resp_dict)
    ...
    def unique_container_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_container_hash = hashlib.sha256(block_string).hexdigest()

        return unique_container_hash
