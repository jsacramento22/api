...
from models.people_inventory.my_garage_car_model \
    import MyGarageCarModel
...
class MyGarageCarView(MyGarageCarModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_inventory_my_garage_car',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_vehicle_hash'] = self.unique_vehicle_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_inventory_my_garage_car', data=resp_dict)
    ...
    def unique_vehicle_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_vehicle_hash = hashlib.sha256(block_string).hexdigest()

        return unique_vehicle_hash
