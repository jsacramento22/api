...
from models.people_inventory.my_pet_model import MyPetModel
...
class MyPetView(MyPetModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_inventory_my_pet',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_pet_hash'] = self.unique_pet_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_inventory_my_pet', data=resp_dict)
    ...
    def unique_pet_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_pet_hash = hashlib.sha256(block_string).hexdigest()

        return unique_pet_hash
