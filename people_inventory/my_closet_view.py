...
from models.people_inventory.my_closet_model import MyClosetModel
...
class MyClosetView(MyClosetModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_inventory_my_closet',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_closet_hash'] = self.unique_closet_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_inventory_my_closet', data=resp_dict)
    ...
    def unique_closet_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_closet_hash = hashlib.sha256(block_string).hexdigest()

        return unique_closet_hash
