...
from models.people_profile.contact_me_model import ContactMeModel
...
class ContactMeView(ContactMeModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_contact_me',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_contact_me', data=resp_dict)
