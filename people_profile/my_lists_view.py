...
from models.people_profile.my_lists_model import MyListsModel
...
class MyListsView(MyListsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_my_lists',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_list_hash'] = self.unique_list_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_profile_my_lists', data=resp_dict)
    ...
    def unique_list_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_list_hash = hashlib.sha256(block_string).hexdigest()

        return unique_list_hash
