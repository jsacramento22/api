...
from models.people_profile.education_model import EducationModel
...
class EducationView(EducationModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_education',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_education', data=resp_dict)
