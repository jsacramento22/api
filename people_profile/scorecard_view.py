...
from models.people_profile.scorecard_model import ScoreCardModel
...
class ScoreCardView(ScoreCardModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_scorecard',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_scorecard', data=resp_dict)
