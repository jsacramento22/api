...
from models.people_profile.social_contacts_model import SocialContactsModel
...
class SocialContactsView(SocialContactsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_social_contacts',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_social_contacts', data=resp_dict)
