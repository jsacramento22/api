...
from models.people_profile.documents_model import DocumentsModel
...
class DocumentsView(DocumentsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_documents',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_documents', data=resp_dict)
