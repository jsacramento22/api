...
from models.people_profile.health_prescription_model \
    import HealthPrescriptionModel
...
class HealthPrescriptionView(HealthPrescriptionModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_health_prescription',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_health_prescription', data=resp_dict)
