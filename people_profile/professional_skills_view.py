...
from models.people_profile.professional_skills_model \
    import ProfessionalSkillsModel
...
class ProfessionalSkillsView(ProfessionalSkillsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_professional_skills',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_professional_skills', data=resp_dict)
