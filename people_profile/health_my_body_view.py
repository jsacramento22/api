...
from models.people_profile.health_my_body_model import HealthMyBodyModel
...
class HealthMyBodyView(HealthMyBodyModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_health_my_body',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_health_my_body', data=resp_dict)
