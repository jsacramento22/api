...
from models.people_profile.health_know_issues_model \
    import HealthKnowIssuesModel
...
class HealthKnowIssuesView(HealthKnowIssuesModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_health_know_issues',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_health_know_issues', data=resp_dict)
