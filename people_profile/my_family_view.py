...
from models.people_profile.my_family_model import MyFamilyModel
...
class MyFamilyView(MyFamilyModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_my_family',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_my_family', data=resp_dict)
