...
from models.people_profile.professional_history_model \
    import ProfessionalHistoryModel
...
class ProfessionalHistoryView(ProfessionalHistoryModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_profile_professional_history',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_profile_professional_history', data=resp_dict)
