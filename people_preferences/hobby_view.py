...
from models.people_preferences.hobby_model import HobbyModel
...
class HobbyView(HobbyModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_hobby',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_hobby_hash'] = self.unique_hobby_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_preferences_hobby', data=resp_dict)
    ...
    def unique_hobby_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_hobby_hash = hashlib.sha256(block_string).hexdigest()

        return unique_hobby_hash
