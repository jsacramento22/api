...
from models.people_preferences.portal_model import PortalModel
...
class PortalView(PortalModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_portal',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_portal_hash'] = self.unique_portal_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_preferences_portal', data=resp_dict)
    ...
    def unique_portal_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_portal_hash = hashlib.sha256(block_string).hexdigest()

        return unique_portal_hash
