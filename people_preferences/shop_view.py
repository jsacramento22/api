...
from models.people_preferences.shop_model import ShopModel
...
class ShopView(ShopModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_shop',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_shop_hash'] = self.unique_shop_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_preferences_shop', data=resp_dict)
    ...
    def unique_shop_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_shop_hash = hashlib.sha256(block_string).hexdigest()

        return unique_shop_hash
