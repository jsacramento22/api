...
from models.people_preferences.products_model import ProductsModel
...
class ProductsView(ProductsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_products',
    ...
    def insert(self, request):
        ...
        res = self.el.insert_el(
            index='myid_people_preferences_products', data=resp_dict)
