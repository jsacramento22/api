...
from models.people_preferences.sports_model import SportsModel
...
class SportsView(SportsModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_sports',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_sport_hash'] = self.unique_sport_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_preferences_sports', data=resp_dict)
    ...
    def unique_sport_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_sport_hash = hashlib.sha256(block_string).hexdigest()

        return unique_sport_hash
