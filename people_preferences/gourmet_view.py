...
from models.people_preferences.gourmet_model import GourmetModel
...
class GourmetView(GourmetModel):
    ...
    def retrieve(self, request, **kwargs):
        ...
        resp_list = self.el.retrieve_el(
            index='myid_people_preferences_gourmet',
    ...
    def insert(self, request):
        ...
        resp_dict['unique_gourmet_hash'] = self.unique_gourmet_hash_string(
            unique_personal_hash)

        res = self.el.insert_el(
            index='myid_people_preferences_gourmet', data=resp_dict)
    ...
    def unique_gourmet_hash_string(self, unique_personal_hash):
        import json
        import hashlib
        ...
        unique_gourmet_hash = hashlib.sha256(block_string).hexdigest()

        return unique_gourmet_hash
